  ...
  return (
    <div className={`ios-statusbar ios-statusbar--${tone}${className ? ` ${className}` : ""}`} aria-hidden="true">
      ...
      <span className="ios-statusbar-icons">
        ...
        <svg className="ios-statusbar-cellular" style={NO_STROKE} width="18" height="12" viewBox="0 0 18 12" fill="none">
        ...
        <svg className="ios-statusbar-wifi" style={NO_STROKE} width="17" height="11.834" viewBox="0 0 17 11.834" fill="none">
        ...
        <svg className="ios-statusbar-battery" style={NO_STROKE} width="27.4" height="13" viewBox="0 0 28 13" fill="none">
          {/* 테두리만 선으로 그린다. strokeWidth 를 명시해 전역 1.7 상속을 막는다. */}
          <rect x=".5" y=".5" width="24" height="12" rx="3.8" stroke="currentColor" strokeWidth="1" strokeOpacity=".35" />
