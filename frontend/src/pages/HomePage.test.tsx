...
const hero = {
  nickname: "박준호(가상)", representative_age: 34, customer_context: "DC 방치", is_demo_login_candidate: true,
  scenario_code: "dc_dormant", scenario_name: "DC형 방치", age_band: "30대", risk_profile: "balanced", investment_horizon_years: 21,
  total_amount_krw: "60000000", accounts: [{ account_id: "dc", account_type: "dc", label: "회사 DC", holdings: [{ holding_id: "deposit", instrument_name: "원리금보장 상품", asset_class_code: "deposit", amount_krw: "60000000", risk_treatment: "capital_preservation" }] }],
  asset_allocations: [{ asset_class_code: "deposit", amount_krw: "60000000", allocation_percent: "100", account_count: 1 }], duplicated_asset_classes: [],
  risk_summary: { dominant_asset_class: "deposit", dominant_asset_percent: "100", general_risky_asset_percent: "0", stress_scenario_code: "equity_drawdown", estimated_stress_loss_percent: "0", is_forecast: false, requires_rebalancing_review: true, policy_label: "정책" }, data_boundary: "mock",
} as DemoHeroPortfolio;
const userContext = {
  auth_user_id: "user-1", nickname: "박준호(가상)", representative_age: 34, customer_context: "DC 방치", scenario_code: "dc_dormant", scenario_name: "DC형 방치", age_band: "30대", risk_profile: "stable", investment_horizon_years: 21, tax_year: 2026, income_basis: "unknown", income_amount_krw: "0", dc_balance_krw: "60000000", irp_balance_krw: "0", pension_savings_balance_krw: "0", total_pension_balance_krw: "60000000", irp_contribution_krw: "0", pension_savings_contribution_krw: "0", as_of_date: "2026-07-21", data_kind: "mock", asset_classes: ["deposit"], defaulted_fields: [],
