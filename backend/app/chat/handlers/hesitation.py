...
HESITATION_ANSWERS: tuple[HesitationAnswer, ...] = (
    HesitationAnswer(
        ...
        body=(
            ...
            "쪽은 약정된 이자를 주는 대신 수익이 제한되고, 실적배당 쪽은 "
            "운용 성과에 따라 오르내려요. 손실 가능성은 이 실적배당에서 "
            "나오고, 얼마나 흔들리는지는 담는 자산의 종류와 비중에 따라 "
            "달라져요."
        ),
        caveat=(
    ...
    HesitationAnswer(
        ...
        body=(
            ...
            "높은지 낮은지는 지나고 나서야 알 수 있어요. 그래서 연금처럼 "
            "기간이 긴 자금은 한 시점의 가격보다 자산을 어떻게 나눠 담았는지를 "
            "더 중요하게 봐요. 시점을 맞히기 어려울 때 여러 번에 나눠 넣는 "
            "적립식을 쓰는 것도 이런 이유예요."
        ),
        caveat=(
    ...
    HesitationAnswer(
        ...
        body=(
            ...
            "따져보는 편이에요. 연금계좌는 넣을 때 세액공제를 받고, 55세 "
            "이후 연금으로 받을 때 낮은 세율이 적용돼요. 그래서 기간이 "
    ...
    HesitationAnswer(
        ...
        body=(
            ...
            "연금저축펀드는 자유납입이라 형편에 맞춰 금액과 시기를 조절할 "
            "수 있어요. 사정이 생기면 납입을 쉬었다가 다시 넣을 수도 있고요. "
            "세액공제 한도는 넣을 수 있는 상한이지 채워야 하는 목표가 "
            "아니에요."
        ),
        caveat=(
    ...
    HesitationAnswer(
        ...
        body=(
            ...
            "10% 가입자는 평균 19.5%를 냈고, 실적배당형 비중이 84%였어요. "
            "하위 10%는 평균 0.5%였고 원리금보장형 비중이 74%였고요. "
            "남들과 견주기보다 이 차이가 어디서 왔는지를 보는 편이 도움이 "
            "돼요."
        ),
        caveat=(
