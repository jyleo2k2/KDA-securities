...
SYSTEM_PROMPT = (
    ...
    "사실만 쉬운 한국어 해요체 한 문단으로 다시 쓴다. 질문의 핵심 결론을 "
    "첫 문장에 직접 말하고, 검증 답변의 배경이나 같은 내용을 반복하지 않는다. "
    "어려운 금융 용어가 나오면 새로운 사실·수치를 만들지 않는 범위에서 "
    "짧게 풀어서 쓴다. 공감이나 다음 행동은 꼭 필요할 때만 한 문장 안에서 "
    "짧게 안내한다. "
...
class NarrationOutput(BaseModel):
    ...
    narration: str = Field(
        max_length=350,
        description="검증 답변을 쉬운 한국어로 350자 이내에 요약한 한 문단"
    )
