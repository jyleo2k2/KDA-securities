...
| **docs/30_스펙** | 어떻게 계산할지 | [아키텍처](./docs/30_스펙/아키텍처.md) · [ETF 적격성](./docs/30_스펙/연금계좌_ETF_적격성_계약.md) · [총수익률·비용](./docs/30_스펙/ETF_총수익률_비용_마스터_계약.md) · [종목 이벤트](./docs/30_스펙/ETF_종목_이벤트_마스터_계약.md) · [교육용 포트폴리오](./docs/30_스펙/교육용_포트폴리오_엔진_계약.md) |
...
- 데이터 기반 1~7과 ETF 운용 가이드 데이터 파이프라인의 로컬 계약 검증을 완료했다.
...
- 로컬 검증: `uv run pytest` **103건**, Ruff, 마이그레이션·seed·내장 SQL 구문 검사 통과.
...
- 다음 작업:
  ...
  3. 대상 Supabase 프로젝트 연결과 원격 통합 검증
