...
- 원격 Supabase(KDA-securities)는 migration 16개·public 테이블 43개·RLS 43/43이다. 원격 마지막 버전 `20260718154819`에 맞춘 로컬 파일명 정합화는 현재 DB 문서 branch에 포함됐으며 main 머지 승인을 기다린다. FSS 88/126행, 뉴스 15건, 지식 10문서/45청크, ETF 상품 2,507행·총수익 이력 217,833행을 유지한다(2026-07-19).
