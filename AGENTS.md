...
> 최종 갱신: 2026-07-10 · 단계: **기획 확정 / 구현 전(현재 레포는 문서만)**

## 한 줄 정의
방치된 3층연금을 통합 진단하고, **근거를 설명하는 AI가 리밸런싱을 제안**하면 유저가 원탭으로 실행하는 모바일 연금 코파일럿. (자문형 — 일임 아님)
...
- **자문형만**: AI는 제안, 결정·실행은 유저 원탭 승인. 일임(전권 위임) 구조 금지.
